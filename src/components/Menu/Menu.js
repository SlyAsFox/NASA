...
import MenuSatellite from './MenuSatellite';
        ...
        return (
            <div className="menu">
                <div className="selector">
                    ...
                    <select id="id3" onChange={this.handleChange} value={selectValue} defaultValue={selectValue}>
